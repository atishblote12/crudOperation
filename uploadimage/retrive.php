<?php 
	...
	// write query
	$query = "SELECT * FROM gallery WHERE image_row = 1";
 ...
 <body>
	...
	<label><h3>retrive image</h3></label>
				...
				<?php 
					while ($data =$result->fetch_object()) {
						...
						echo "<tr>";
							...
							echo "<td > <img src='images/$location' height='100px' width='150px'  object-fit='cover'> </td>" ;
															
							echo "<td> <a href='deleteimg.php?ImgDelete=$data->id'  class=' btn-danger btn-sm'>Delete</a></td>";								
